...
from data_ingest.views import EditNormalizeView, DataBrowseView, FileUploadCreateView, \
    UploadDataJsonView, CatchFieldsJsonView, DataNormalizationView, NormalizeSourceView, CommitView, \
...
urlpatterns = patterns(
    ...
    url(r'^normalize-source/$', login_required(NormalizeSourceView.as_view()), name='normalize-source'),
